...
--------
These visualizations are based on the exit surveys from the past three Happiness Retreats at UO. Student health and wellness are important to success in life and academia. We are excited to continue spreading positivity across campus. Updated 5/1/2019
...
ggplot(OH0, aes(x = fct_reorder(Category, n), n)) +
  ...
  guides(fill = "none")+
  geom_text(data = OH0[1,], aes(label = Gender), hjust = 0, color = "gray40")+
...
experience_df <- tibble(line = 1:23, text = experience)
